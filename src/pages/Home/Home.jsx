...
export default function Home() {
  ...
  // ✅ Replace isMounted state with useRef
  ...
  // 🔹 Removed categoryCount since it's not used

  // ✅ Fetch localStorage data only on the first render
  useEffect(() => {
  ...
  // ✅ Save expense list & update expense calculations
  useEffect(() => {
  ...
  }, [balance]); // ✅ No isMounted dependency needed
